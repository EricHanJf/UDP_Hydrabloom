...
var pubnub;
var appChannel = "pi-hardware-channel";
var ttl = 5;
user_Id = "{{ user_id }}"; // sendEvent("get_user_token");
...
var setupPubNub = function setupPubNub() {
  ...
  pubnub.addListener({
    ...
    message: function message(messageEvent) {
      console.log("Message received:", messageEvent.message); // Here you can handle the incoming message
    }
...
function sendEvent(value) {
  ...
  fetch(value, {
    ...
    if (responseJson.hasOwnProperty("token")) {
      ...
      console.log("Cipher Key: " + responseJson.cipher_key); //pubnub.setCipherKey(responseJson.cipher_key);
